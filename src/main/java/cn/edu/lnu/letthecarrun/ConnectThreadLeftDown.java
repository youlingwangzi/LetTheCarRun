...
public class ConnectThreadLeftDown extends Thread {
    private BluetoothSocket socket;
    private final BluetoothDevice mmDevice;
    BluetoothAdapter mBluetoothAdapter =null;
    Handler handler = null;

    public ConnectThreadLeftDown(BluetoothDevice device,Handler handler, BluetoothAdapter mBluetoothAdapter, BluetoothSocket socket) {
        mmDevice = device;
