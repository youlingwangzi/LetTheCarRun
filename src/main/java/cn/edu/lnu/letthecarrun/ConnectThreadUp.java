 ...
 * 前进信息发送线程
 */
public class ConnectThreadUp extends Thread {
    private BluetoothSocket socket;
    private final BluetoothDevice mmDevice;
    BluetoothAdapter mBluetoothAdapter =null;
    Handler handler = null;

    public ConnectThreadUp(BluetoothDevice device,Handler handler, BluetoothAdapter mBluetoothAdapter,BluetoothSocket socket) {
        mmDevice = device;
